/*
 * Dice and Roll Program that rolls Dice for user Five Times, Asks User for High, Low or Equal and shows result
 * This Program uses Scanner, If else and SWITCH for that
 * Bishwash Khakda
 * 09/14/2022
 */
